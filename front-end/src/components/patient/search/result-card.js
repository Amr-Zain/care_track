        ...
        <Row className="g-0 h-100">
          <Col sm={12} md={5} lg={4} className="d-flex align-items-center ">
            <Card.Img
              ...
              onError={(e) =>
                (e.target.src = specialization
                  ? "https://care-track-api-production.up.railway.app/public/images/user-4.jpg"
                  : "https://care-track-api-production.up.railway.app/public/images/user-11.jpg")
              }
              alt={name}
            ...
            <Card.Body className="h-100 d-flex flex-column">
              <div className="d-flex justify-content-between align-items-start mb-3">
                <Card.Title className="mb-0">
                  <Link
                    to={`/${PROFILE}/${type}/${id}`}
                    className="underline-pointer text-dark"
                  >
                    {type === "doctor" && "Dr."}
                    {name}
                  </Link>
              ...
              {description && (
                <Card.Text className="text-muted mb-3 border-bottom">
                  {description}
                </Card.Text>
              )}
              ...
              <div
                className={`mt-auto d-flex justify-content-${
                  isPage ? "end" : "between"
                } align-items-center`}
              >
                {!isPage && (
